...
const EmployeeSalaryEdit: React.FC = () => {
  ...
  return (
    <PageContainer
      ...
      extra={
        <Space>
          <Button onClick={() => history.push(`/salary/employees/${empId}`)}>取消</Button>
    ...
    >
      <Card style={{ maxWidth: 720 }}>
        <Form form={form} layout="vertical">
          <Form.Item name="accountId" label="薪资账套" rules={[{ required: true }]}>
            <Select placeholder="选择账套" options={accounts} />
          </Form.Item>
          <Form.Item name="baseSalary" label="月基本工资" rules={[{ required: true }]}>
